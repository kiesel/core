...
use lang\archive\PharArchiveClassLoader;
use lang\archive\PharArchive;
use io\FileUtil;
 ...
 */
class PharArchiveClassLoaderTest extends TestCase {
  ...
  public function setUp() {
    $this->fixture= new PharArchiveClassLoader(new PharArchive(
      $this->getClass()->getPackage()->getResourceAsStream('archive.phar')
    ));
  }
